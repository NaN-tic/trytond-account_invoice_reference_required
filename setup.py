...
MODULE = 'account_invoice_reference_required'
PREFIX = 'nantic'
MODULE2PREFIX = {}
OWNER = {
    'nantic':'NaN-tic',
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-account_invoice_reference_required',
    download_url='https://github.com:nantic/trytond-account_invoice_reference_required.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_invoice_reference_required.git'
    },
    classifiers=[
